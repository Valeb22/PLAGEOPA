...
public class RegistroServiceImpl implements RegistroService {
    ...
    public RegistroResponseDto obtenerPorCedula(String cedula) {
        ...
        List<CultivoDto> cds = cultivoRepo.findByFincaId(finca == null ? -1 : finca.getId())
                .stream()
                .map(c -> {
    ...
    private void saveLog(Integer userId, String tabla, String op, Integer idAfectado, String detalle) {
        ...
        if (userId != null) {
            ...
            log.setUsuario(u); // FK si la tienes en la entidad
            if (u != null) {
    ...
    private static String joinChanges(List<String> changes) {
        return (changes == null || changes.isEmpty()) ? "(sin cambios detectados)" : String.join("; ", changes);
    }
}
